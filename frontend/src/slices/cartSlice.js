...
const cartSlice = createSlice({
  ...
  reducers: {
    ...
    //====Redux reducer function that takes state and action as parameters. It updates the paymentMethod property of state with the value from action.payload. Afterward, it appears to call a function named updateCard with the modified state as an argument.
    savePaymentMethod: (state, action) => {
      state.paymentMethod = action.payload;
      return updateCart(state);
    },
    //after we create the order we want to clear items from cart
